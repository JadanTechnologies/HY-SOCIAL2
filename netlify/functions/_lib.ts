...
export const users: DBUser[] = [
  { id: 'u-jadan', email: 'jadanexpress.info@gmail.com', username: 'jadan', displayName: 'Jabir Dangaskiya', passwordHash: 'jadan', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80', bio: 'Tech innovator, Creator & Media Producer 🚀🇳🇬 | Building the future on HY | Kano & Abuja ✨', website: 'https://jadanexpress.info', verified: true, followersCount: 315000, followingCount: 280, likesCount: 4200000, role: 'creator' },
  { id: 'u-current', email: 'tobi@hy.app', username: 'tobi_bakare', displayName: 'Tobi Bakare', passwordHash: 'password123', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&auto=format&fit=crop&q=80', bio: 'Filmmaker & Visual Storyteller 🎥 | Capturing Lagos golden hours & street stories 🇳🇬✨ Lekki, Lagos', website: 'https://tobibakare.ng', verified: true, followersCount: 184200, followingCount: 340, likesCount: 2420000, role: 'creator' },
  { id: 'u-1', email: 'amaka@hy.app', username: 'amaka_steps', displayName: 'Amaka Okafor', passwordHash: 'password123', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&auto=format&fit=crop&q=80', bio: 'Afrobeats & Amapiano choreographer 💃🏿 Lagos dance academy | Catch the rhythm 🇳🇬✨', website: 'https://amakasteps.com', verified: true, followersCount: 532000, followingCount: 180, likesCount: 6800000, role: 'creator' },
  { id: 'u-2', email: 'tunde@hy.app', username: 'tunde_soundz', displayName: 'Tunde Adebayo', passwordHash: 'password123', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80', bio: 'Afro-fusion music producer & audio architect 🎹 Lekki Phase 1, Lagos | Grammy season loading ⚡🇳🇬', website: 'https://tundesoundz.io', verified: true, followersCount: 398000, followingCount: 420, likesCount: 4300000, role: 'creator' },
  { id: 'u-3', email: 'kemi@hy.app', username: 'kemi_delights', displayName: 'Kemi Adeleke', passwordHash: 'password123', avatar: 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?w=400&auto=format&fit=crop&q=80', bio: 'Jollof connoisseur, food creator & Naija street-food explorer 🍲 Suya & spicy treats 🌶️ Abuja & Lagos', website: 'https://kemidelights.ng', verified: true, followersCount: 267500, followingCount: 290, likesCount: 3890000, role: 'creator' },
  { id: 'u-4', email: 'emeka@hy.app', username: 'emeka_skates', displayName: 'Emeka Nwosu', passwordHash: 'password123', avatar: 'https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?w=400&auto=format&fit=crop&q=80', bio: 'Lagos street skater & concrete pioneer 🛹 National Stadium Surulere & TBS sessions 🇳🇬', verified: false, followersCount: 142000, followingCount: 195, likesCount: 1950000, role: 'creator' },
];

export const sounds: DBSound[] = [
...
export let currentUserId: string | null = 'u-current';

export const userLikes = new Set<string>(['v-1', 'v-4']);
export const userSaves = new Set<string>(['v-2']);
export const userFollows = new Set<string>(['u-1', 'u-2']);

export function enrichVideo(video: DBVideo) {
...
export function getUserId(event: HandlerEvent): string | null {
  return event.headers['x-user-id'] || event.headers['X-User-Id'] || currentUserId;
}

export function parseBody(event: HandlerEvent): any {
...
export function handleOptions(): { statusCode: number; headers: any; body: string } {
  return {
    statusCode: 200,
    headers: {
      'Access-Control-Allow-Origin': '*',
